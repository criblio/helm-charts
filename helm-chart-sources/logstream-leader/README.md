...
|criblImage.tag|3.2.2|The container image tag to pull from. By default, this will use the same version as the chart release, but you can also use version tags (like "3.1.0") to pull specific versions of LogStream. |
